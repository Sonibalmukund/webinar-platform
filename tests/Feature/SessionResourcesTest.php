...
class SessionResourcesTest extends TestCase
{
    ...
    public function test_admin_can_save_resources_and_learner_sees_them_in_room_and_not_on_landing(): void
    {
        ...
        $payload = ['contact_mobile' => '+91 98765 43210', 'title' => $webinar->title, 'slug' => $webinar->slug, 'status' => 'live', 'language' => 'en', 'timezone' => 'Asia/Kolkata', 'starts_at' => now()->subHour()->timezone('Asia/Kolkata')->format('Y-m-d H:i:s'), 'ends_at' => now()->addHours(2)->timezone('Asia/Kolkata')->format('Y-m-d H:i:s'), 'early_entry_minutes' => 30, 'registration_type' => 'free', 'session_resources' => "Session guide | https://example.com/guide.pdf\nUnsafe | javascript:alert(1)"];
