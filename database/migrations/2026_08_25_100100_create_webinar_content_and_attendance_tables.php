...
return new class extends Migration
{
    ...
    {
        Schema::create('webinar_agenda_items', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('webinar_attendees', function (Blueprint $table) {
            $table->id();
            $table->foreignId('webinar_id')->constrained()->cascadeOnDelete();
        ...
        Schema::create('webinar_bookmarks', function (Blueprint $table) {
            $table->id();
            $table->foreignId('webinar_id')->constrained()->cascadeOnDelete();
            $table->foreignId('user_id')->constrained()->cascadeOnDelete();
            $table->unique(['webinar_id', 'user_id']);
    ...
    {
        foreach (['feedback', 'webinar_reviews', 'webinar_recordings', 'webinar_bookmarks', 'webinar_attendees', 'webinar_resources', 'webinar_agenda_items'] as $table) {
