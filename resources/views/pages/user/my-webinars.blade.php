...
@php($isAdmitted=!in_array($row['registration']->status,['waitlisted','cancelled','rejected'],true))
@php($canEnter=$isAdmitted && $webinar->canEnter())
