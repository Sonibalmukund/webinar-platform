...
@section('content')
<div class="page-heading"><div><span class="eyebrow">COMMUNICATION</span><h1>Notifications</h1><p>Send realtime announcements to learners.</p></div>@if(auth()->user()->hasRole('super-admin') || auth()->user()->hasPermission('notifications.create'))<a class="btn btn-gradient" href="{{ route('admin.notifications.create') }}"><i class="bi bi-send"></i> Create notification</a>@endif</div>
