...
class WebinarController extends Controller
{
    ...
    public function dashboard(Request $request, Webinar $webinar): View
    {
        ...
        return view('pages.user.webinar-dashboard', compact('webinar', 'banners', 'brands', 'agenda', 'resources', 'activePoll', 'chatMessages', 'feedback', 'pollResponse', 'metrics', 'certificate', 'liveViewers', 'raisedHand'));
    }
